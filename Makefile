...
srcdir = /root/klininfo_v0.2/klininfo
top_srcdir = /root/klininfo_v0.2/klininfo
VPATH = /root/klininfo_v0.2/klininfo
pkgdatadir = $(datadir)/klininfo
pkglibdir = $(libdir)/klininfo
pkgincludedir = $(includedir)/klininfo
top_builddir = .
...
ACLOCAL = ${SHELL} /root/klininfo_v0.2/klininfo/admin/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /root/klininfo_v0.2/klininfo/admin/missing --run tar
AR = ar
ARTSCCONFIG = /opt/kde/bin/artsc-config
AUTOCONF = $(SHELL) $(top_srcdir)/admin/cvs.sh configure || touch configure
AUTODIRS = 
AUTOHEADER = ${SHELL} /root/klininfo_v0.2/klininfo/admin/missing --run autoheader
AUTOMAKE = ${SHELL} /root/klininfo_v0.2/klininfo/admin/missing --run automake-1.8
AWK = gawk
CC = gcc
...
CXXFLAGS = -Wnon-virtual-dtor -Wno-long-long -Wundef -Wall -W -Wpointer-arith -Wwrite-strings -ansi -D_XOPEN_SOURCE=500 -D_BSD_SOURCE -Wcast-align -Wconversion -Wchar-subscripts -O2 -O2 -g0 -Wformat-security -Wmissing-format-attribute -fno-exceptions -fno-check-new -fno-common
CYGPATH_W = echo
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/klininfo_v0.2/klininfo/admin/missing --run makeinfo
...
SHELL = /bin/sh
STRIP = strip
TOPSUBDIRS =  doc icons pixmaps po src
...
infodir = ${prefix}/info
install_sh = /root/klininfo_v0.2/klininfo/admin/install-sh
...
docsdir = /usr/doc/klininfo-0.2 
docs_DATA = AUTHORS ChangeLog COPYING INSTALL README TODO
#>- all: config.h
#>+ 1
...
#>+ 2
KDE_DIST=stamp-h.in klininfo.kdevelop.pcs subdirs Makefile.in configure.files config.h.in klininfo.kdevelop klininfo.kdevelop.spec configure.in Makefile.cvs klininfo.kdevses aclocal.m4 Doxyfile acinclude.m4 Makefile.am configure 
